...
export default class Combobox extends React.Component {
    ...
    render() {
        const {bgColor, data, itemHeight, visibleItems, highlight, placeholder} = this.props;
    ...
    onInputHandler(event) {
        ...
        const {data, filterProperties} = this.props;
        this.closeSuggestionsList();
        const results = filterData(data, filterProperties, val) || [];
